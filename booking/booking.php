                    ...
                    if(isset($_SESSION["permission"])){
                        if ($_SESSION["permission"]==$check) {
                            ...
                            <div class="project-info">
                                ...
                                <div class="project-info">
                                    <h4>Stok Barang</h4>
                                    <input name="stock" value="'.$row['stock'].'">
                                </div>
                                <div class="project-info">
                                    <h4>Kategori</h4>
                                    <input name="kategori" value="'.$kat.'">
                                </div>
                                <div class="project-info">
                                    <input class="btn btn-info" name="submit" type="submit" value="Update">
                                    <a name="delete" href="deleteitem.php?id='.$row['id'].'&img='.$row['gambar'].'" class="btn btn-danger">Delete</a>
                                </div>
                                <div class="project-info">
                            ...
                            <div class="wow fadeInUp col-md-7 col-sm-7" data-wow-delay="1.6s">
                                <h4>Deskripsi</h4>
                                <textarea rows="4" cols="63" id="desc" name="desc">'.$desc.'</textarea>
                        ...
                        ';
                            ...
                            <div class="project-info">
                                ...
                                <div class="project-info">
                                    <h4>Nama</h4>
                                    <p name="nama">'.$row['nama'].'</p>
                                </div>
                                <div class="project-info">
                                    <h4>Stok Barang</h4>
                                    <p name="stock">'.$row['stock'].'</p>
                                </div>
                                <div class="project-info">
                                    <h4>Kategori</h4>
                                    <p name="kategori">'.$kat.'</p>
                                </div>
                            </div>
                            <div class="wow fadeInUp col-md-7 col-sm-7" data-wow-delay="1.6s">
                                <h4>Deskripsi</h4>
...
<script src="../js/jquery-3.3.1.min.js"></script>
    ...
    //   $(function () {
        ...
        function myF(){
            ...
            $('button[name=edit]').replaceWith($('<input class="btn btn-info" name="submit" type="submit" value="Save">'));
            FAuto();
        }
